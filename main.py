...
def main():
    ...
    oMdes = [
        pin.SE3(
            np.array(
                [
                    [-0.859547, 0.505643, -0.0741905],
                    [-0.505646, -0.820367, 0.267059],
                    [0.0741733, 0.267064, 0.96082],
                ]
            ),
            np.array([0.468445, 0.236337, 0.934516]),
        ),
        pin.SE3(np.eye(3), np.array([0.0, 0.0, 1.261])),
        pin.SE3(np.eye(3), np.array([0.5, 0.5, 0.5])),
